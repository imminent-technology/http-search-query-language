...
| AQL | [IBM QRadar Ariel Query Language](https://www.ibm.com/docs/en/qsip/7.5.0?topic=aql-ariel-query-language) |
...
| FQL | [CrowdStrike Falcon Query Language](https://developer.crowdstrike.com/api-reference/falcon-query-language/) |
...
| jOOQ | [Typesafe SQL DSL for Java](https://www.jooq.org/) |
...
| JSONata | [JSON query and transformation language](https://jsonata.org/) |
...
| Rego | [Open Policy Agent policy language](https://www.openpolicyagent.org/docs/policy-language) |
